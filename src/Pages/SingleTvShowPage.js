...
const SingleTvShowPage = () => {
  ...
  const fetchVideo = async () => {
    try{
      const response = await fetch(`https://api.themoviedb.org/3/tv/${id}/videos?api_key=${process.env.REACT_APP_ACCESS_KEY}&language=en-US`);
  ...
  const fetchDetails = async () => {
    const response = await fetch(`https://api.themoviedb.org/3/tv/${id}?api_key=${process.env.REACT_APP_ACCESS_KEY}&language=en-US`);
    const data = await response.json();
    setDetails(data);
  }
    ...
    const fetchSimilar = async () => {
      const response = await fetch(`https://api.themoviedb.org/3/tv/${id}/similar?api_key=${process.env.REACT_APP_ACCESS_KEY}&language=en-US&page=1`);
      const data = await response.json();
